...
sleep 2s
sudo docker run --name worker3 --net work3-net --ip 192.168.5.21 -p 4646:4646 -dt proj:work3
sleep 2s
sudo docker run --name worker4 --net work4-net --ip 192.168.6.21 -p 4747:4747 -dt proj:work4
sleep 2s
