...
parameter_servers = ["127.0.0.1:2530"]
workers = ["127.0.0.1:2550", "127.0.0.1:2580", "127.0.0.1:4000", "127.0.0.1:4005"]

cluster = tf.train.ClusterSpec({"ps": parameter_servers, "worker": workers})

# input flags
tf.flags.DEFINE_string("job_name", "worker", "Either 'ps' or 'worker'")
tf.flags.DEFINE_integer("task_index", 2, "Index of task within the job")
